...
% RubineRed
\newcommand{\cemph}[1]{{\color{WildStrawberry}\textbf{#1}}}
...
\author{Ιωάννης Σιγλίδης}
\supervisoremp{Ανδρέας Γεώργιος Σταφυλοπάτης}
\supervisorlix{Μιχάλης Βαζιργιάννης}
\TRnumber{ΕΣΒΓΔ-ΔΙΠΛ-2017-02}
\epitropiF{Μιχάλης Βαζιργιάννης}
\epitropiS{Γιώργος Στάμου}
