\begin{abstract}
Το πρόβλημα ακριβούς μέτρησης της ομοιότητας μεταξύ δεδομένων που έχουν αναπαρασταθεί με τη μορφή γράφων βρίσκεται στο κέντρο πολλών εφαρμογών σε ένα μεγάλο εύρος επιστημονικών και τεχνολογικών κλάδων.
...
Εστιάζοντας σε διαφορετικά δομικά χαρακτηρηστικά των γράφων, μπορούν στην πολυμορφία τους να παρέχουν μία λύση αιχμής σε ένα πλήθος εφαρμογών του πραγματικού κόσμου.
Σε αυτήν την διπλωματική παρουσιάζουμε την ανάπτυξη του \en{GraKeL}, μίας βιβλιοθήκης που ενοποιεί μία ικανή ποσότητα σημαντικών πυρήνων γράφων της υπάρχουσας βιβλιογραφίας σε μία κοινή αντικειμενοστρεφή δομή.
...
Επίσης θα ήθελα να ευχαριστήσω τον καθηγητή Μιχάλη Βαζιργιάννη για την κοπιώδη υποστήριξη και το ενδιαφέρον του όλο το διάστημα που εργαζόμουν μαζί του στο Εργαστήριο \en{LiX}, στο Παρίσι. 
